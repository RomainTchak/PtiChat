    ...
    public class Client
    {
        ...
        void EnvoiMessage()
        {
            while (true)
            {
                ...
                //msgToSend.Target = ConnectedUsers[0];
                // ****************************************************************************************
        ...
        {
            MessagesToSend.Enqueue(new Message { Body = "Choroncos" });
            IPAddress ipServer;
            ...
            //Thread updatingThread = new Thread(() => UpdateConnection());
            sendingThread.Start();
